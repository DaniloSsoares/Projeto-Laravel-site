...
@if (Route::has('login'))
  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
    ...
    <div class="bg-white w-full shadow rounded p-8 sm:p-12 -mt-72">
        ...
        <form method="POST" action="/atualizar.jogos/{{$jogos->id}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="md:flex items-center mt-12">
                <div class="w-full md:w-1/2 flex flex-col mt-4">
                    ...
                    <input type="text" value="{{$jogos->titulo}}" name="titulo" placeholder="Título" class="leading-none text-gray-900 p-2 focus:outline-none focus:border-blue-700 mt-3 bg-gray-200 border rounded border-gray-200" />
                </div>
