...
<body class="bg-gradient-to-b from-red-4500 to-black dark:bg-zinc-900 text-black dark:text-white">
  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
   ...
   <button type="button" class="absolute top-0 left-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
    ...
    <main class="mt-10 container mx-auto px-6">
        ...
        <h1 class="text-3xl font-bold text-center text-white mb-10">Bem-vindo <div>{{Auth::user()->name}}</div></h1>
