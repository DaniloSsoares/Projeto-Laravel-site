        ...
        <form method="POST" action="/atualizar.jogo/{{$jogo->id}}" enctype="multipart/form-data">
            ...
            <div class="md:flex items-center mt-6">
                <div class="w-full md:w-1/2 flex flex-col mt-4">
                    ...
                    <input type="file" name="capa" value="{{$jogo->titulo}}" class="leading-none text-gray-900 p-2 focus:outline-none focus:border-blue-700 mt-3 bg-gray-200 border rounded border-gray-200" />
                </div>
            </div>
