...
<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Flexbox para layout, espaçando itens para as extremidades opostas -->
        <div class="flex justify-between h-16">
            <div class="flex">
                
                <!-- Seção do logotipo -->
                <div class="shrink-0 flex items-center">
                    <!-- Link que redireciona para a rota 'dashboard' -->
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <!-- Componente de link de navegação para o Dashboard. O atributo :active verifica se a rota atual é o Dashboard -->
