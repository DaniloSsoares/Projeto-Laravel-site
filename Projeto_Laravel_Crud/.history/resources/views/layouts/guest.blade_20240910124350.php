        ...
        <nav class="bg-white border-gray-200 white:bg-gray-900">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="flex items-center space-x-4">
                    @auth
                        <a href="{{ url('/profile') }}" class="block py-2 px-3 text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white">Perfil</a>
                    @endauth
                    @guest
                        <a href="{{ route('login') }}" class="block py-2 px-3 text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white">Login</a>
                        <a href="{{ route('register') }}" class="block py-2 px-3 text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white">Registrar</a>
                    @endguest
                </div>
            </div>
        </nav>
