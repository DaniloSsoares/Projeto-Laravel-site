...
<body class=" bg-gradient-to-b from-red-600 to-black h-96text-black dark:text-white">
  ...
  <a href="{{ url('/') }}" class="flex items-center space-x-3 rtl:space-x-reverse">
   ...
   <button type="button" class="absolute top-0 left-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
    ...
    <!-- Main Content -->
    <main class=" bg-gray-100 dark:bg-zinc-900  mt-10 container mx-auto px-6">


        <h1 class="text-3xl font-bold text-center mb-10">Bem-vindo ao Laravel Breeze</h1>
